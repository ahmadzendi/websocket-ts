...
def format_transaction_display(buy: str, sell: str, diff_display: str) -> str:
    return f'<span class="tx-row">Beli: {buy} Jual: {sell} <span class="tx-diff">{diff_display}</span></span>'
...
.st-up{color:#00C853;animation:pulse-up 0.6s ease-in-out}
.st-down{color:#FF1744;animation:pulse-down 0.6s ease-in-out}
.st-neutral{color:#9E9E9E}
.st-icon-sm{display:inline-block;width:12px;height:12px;vertical-align:middle;margin-right:1px;fill:currentColor}
.tx-row{display:inline-flex;align-items:center;gap:4px;flex-wrap:nowrap}
.tx-diff{display:inline-flex;align-items:center;margin-left:6px;padding:1px 5px;background:rgba(0,0,0,0.05);border-radius:3px}
.dark-mode .tx-diff{background:rgba(255,255,255,0.08)}
.diff-up-sm{color:#00C853;font-weight:bold;font-size:0.82em}
.diff-down-sm{color:#FF1744;font-weight:bold;font-size:0.82em}
.diff-neutral-sm{color:#9E9E9E;font-size:0.82em}
...
.gram-text{color:#666;font-size:0.9em}
...
.dark-mode .diff-up-sm,.dark-mode .profit-up,.dark-mode .profit-icon-up{color:#00E676}
.dark-mode .diff-down-sm,.dark-mode .profit-down,.dark-mode .profit-icon-down{color:#FF5252}
.dark-mode .gram-text{color:#aaa}
...
.st-icon-sm{width:10px;height:10px}
.diff-up-sm,.diff-down-sm,.diff-neutral-sm{font-size:0.78em}
}
</style>
</head>
<body>
